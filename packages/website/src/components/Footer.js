...
const Footer = ({ socialMedia, address }) => {
  ...
  const addressString = documentToHtmlString(address);
    ...
    <Content>
      <Container className="flex justify-between">
        <div>
          ...
          <Menus>
            <Menu>
              <MenuHeader>#GNM2019</MenuHeader>
              <MenuItems>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
            ...
            <Menu>
              <MenuHeader>Bible Lessons</MenuHeader>
              <MenuItems>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
            ...
            <Menu>
              <MenuHeader>Our Beliefs</MenuHeader>
              <MenuItems>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
                <MenuItem>The Campaign</MenuItem>
        ...
        <div>
          <div className="flex items-end">
            <p className="mr-4 mb-3 text-sm text-right">
          ...
          <div
            className="text-right text-sm mt-6"
...
const Menu = styled.article.attrs({
  className: 'mr-24',
})`
  &:last-of-type {
    margin-right: 0;
...
const MenuHeader = styled.p.attrs({
  className: 'text-white font-bold text-md mb-8',
})``;
...
const MenuItem = ({ children, ...rest }) => (
  <li className="mb-6 text-sm text-white">
    <a {...rest}>{children}</a>
  </li>
);
...
const SocialIcon = ({ children, ...rest }) => {
  ...
  return (
    <Url {...rest} className="inline-block mr-6">
      {children}
    </Url>
  );
};
