        ...
        <div className="row">
          <div className="col-md-12">
            <div className="tab-content">
              ...
              <p>
                GNM Fieldwork ("us", "we", or "our") operates the GNM Fieldwork
              ...
              <p>
                ...
                and the choices you have associated with that data. The Privacy
                Policy for GNM Fieldwork has been created with the help of
                &nbsp;
              ...
              <ul>
                <li>
                  ...
                  <p>
                    Service is the GNM Fieldwork mobile application operated by
                    GNM Fieldwork
                  </p>
                </li>
                <li>
              ...
              <p>GNM Fieldwork uses the collected data for various purposes:</p>
              <ul>
              ...
              <p>
                GNM Fieldwork will take all steps reasonably necessary to ensure
              ...
              <p>
                GNM Fieldwork may disclose your Personal Data in the good faith
                belief that such action is necessary to:
              </p>
              <ul>
                <li>To comply with a legal obligation</li>
                <li>
                  To protect and defend the rights or property of GNM Fieldwork
                </li>
                <li>
              ...
              <ul>
                <li>By email: hello.gnm2019@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
