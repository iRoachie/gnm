          ...
          <div class="row">
            <div class="col-md-12">
              <div class="tab-content">
                ...
                <p>
                  GNM Fieldwork ("us", "we", or "our") operates the GNM
                  Fieldwork mobile application (hereinafter referred to as the
                  "Service").
                </p>
                ...
                <p>
                  ...
                  data. The Privacy Policy for GNM Fieldwork has been created
                  with the help of &nbsp;
                ...
                <ul>
                  <li>
                    ...
                    <p>
                      Service is the GNM Fieldwork mobile application operated
                      by GNM Fieldwork
                    </p>
                  </li>
                  <li>
                ...
                <p>
                  GNM Fieldwork uses the collected data for various purposes:
                </p>
                <ul>
                ...
                <p>
                  GNM Fieldwork will take all steps reasonably necessary to
                ...
                <p>
                  GNM Fieldwork may disclose your Personal Data in the good
                  faith belief that such action is necessary to:
                </p>
                <ul>
                  <li>To comply with a legal obligation</li>
                  <li>
                    To protect and defend the rights or property of GNM
                    Fieldwork
                  </li>
                  <li>
