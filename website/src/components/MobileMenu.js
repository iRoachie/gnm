...
const NavLink = ({ Tag = Link, ...rest }) => {
  ...
  if (rest.to) {
    rest.activeClassName = 'text-accent';
  }

  return (
    <li className="text-2xl leading-loose font-medium">
      <Tag {...rest} onClick={toggleMenu} className="flex items-center">
        {rest.children}
      </Tag>
    </li>
  );
      ...
      >
        <ul>
          ...
          >
            Our Beliefs
            <svg
              className="external-link ml-4 relative"
